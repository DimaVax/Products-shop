...
const items = [
  ...
  },
  {
    ...
    price: 300,
    photo:
      "https://cdn.food.ru/unsigned/fit/640/480/ce/0/czM6Ly9tZWRpYS9waWN0dXJlcy9wcm9kdWN0cy8xMTUvY292ZXJzL0hRazJXOC5qcGc.jpg",
  },
  {
    name: "orange",
    price: 150,
  ...
  },
  {
    ...
    price: 350,
    photo:
      "https://www.heddensofwoodtown.co.uk/wp-content/uploads/2020/07/Mango_opt.jpg",
  },
  {
    name: "pineapple",
    price: 400,
    photo:
      "https://bazarekpolski.pl/wp-content/uploads/2020/10/ananas-600x600.jpg",
  },
  {
    name: "strawberry",
    price: 180,
    photo:
      "https://weresmartworld.com/sites/default/files/styles/full_screen/public/2021-05/aardbeien-3.jpg?itok=VKyyMjjg",
  },
  {
    name: "watermallon",
    price: 150,
  ...
  },
  {
    ...
    price: 100,
    photo:
      "https://static.libertyprim.com/files/familles/prune-large.jpg?1569271837",
  },
];
...
function createList() {
  const markup = items
    .map((product) =>
        ...
        <img class="products__img" src="${product.photo}" data-photo="${product.photo}" alt="">
    </li>`
    )
    .join("");
...
//   if (e.target.nodeName === 'LI') { перевірка спрацює лише при кліку на тег лі, при кліку на дітей лі нічого не спрацює.
...
function closeInfoModal(e) {
  ...
  exit.removeEventListener("click", closeInfoModal);
  dynamicList.addEventListener("click", openInfoModal);
}
